...
const TentativeTimeline: React.FC = () => {
  ...
  const ScheduleDay = ({ title, schedule }: { title: string; schedule: typeof day1Schedule }) => (
    ...
    <section className="py-20" id="tentative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <ScheduleDay title="Day 1" schedule={day1Schedule} />
          <ScheduleDay title="Day 2" schedule={day2Schedule} />
        </div>
      </div>
    </section>
  );
